...
<!-- badges: end --> An `R` package for calculating varieties of
Kendall’s tau.

**Work in progress!** Analytical confidence intervals hopefully coming
soon, along with a preprint. Expect breaking changes to the API.
...
|:---------------------------|:-------------|:----------|:----------|:-----------|
| Generalized tau[^1]        | `tau`        | -0.982    | -0.34     | 𐄂          |
| Strict generalized tau[^2] | `tau_strict` | -0.493    | -0.643    | 𐄂          |
| Kendall’s tau (a)[^3]      | `tau_a`      | -0.643    | -0.643    | 🗸          |
| Kendall’s tau (b)[^4]      | `tau_b`      | -0.795    | -0.795    | 🗸          |
| Stuart’s tau (c)[^5]       | `tau_c`      | -0.935    | -0.935    | 🗸          |
| Goodman–Kruskall gamma[^6] | `gk_gamma`   | -0.976    | -0.976    | 🗸          |
| Somer’s D[^7]              | `somers_d`   | -0.97     | -0.652    | 𐄂          |
| Wilson’s E[^8]             | `wilsons_e`  | -0.65     | -0.65     | 🗸          |
| Leik–Gove D[^9]            | `lg_d`       | -0.964    | -0.49     | 𐄂          |

[^1]: Moss, J. (2024). Kendall’s tau and proportional reduction in risk:
...
[^4]: Kendall, M. G. (1945). The treatment of ties in ranking problems.
    Biometrika, 33, 239–251. <https://doi.org/10.1093/biomet/33.3.239>

[^5]: Stuart, A. (1953). The Estimation and Comparison of Strengths of
    Association in Contingency Tables. Biometrika, 40(1/2), 105–110.
    <https://doi.org/10.2307/2333101>

[^6]: Somers, R. H. (1962). A New Asymmetric Measure of Association for
    Ordinal Variables. American Sociological Review, 27(6), 799–811.
    <https://doi.org/10.2307/2090408>

[^7]: Goodman, L. A., & Kruskal, W. H. (1979). Measures of Association
...
[^8]: Wilson, T. P. (1974). Measures of association for bivariate
...
[^9]: Leik, R. K., & Gove, W. R. (1969). The Conception and Measurement
