...
<!-- badges: end -->
An `R` package for calculating varieties of Kendall's tau. 

**Work in progress!** Analytical confidence intervals hopefully coming soon, along with a preprint. Expect breaking changes to the API.
